...
sqlite_autoindex_einihongo_segdir_1                       [unique index]
  level                             unknown
  idx                               unknown



einihongo_segments                                               [table]
------------------------------------------------------------------------
  blockid                           INTEGER
  block                             BLOB
